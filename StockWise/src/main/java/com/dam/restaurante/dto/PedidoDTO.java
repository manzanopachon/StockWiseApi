...
public class PedidoDTO {
    ...
    public List<Long> getPlatos() { return platos; }
    public void setPlatos(List<Long> platos) { this.platos = platos; }

    public List<PlatoInfo> getDetallesPlatos() { return detallesPlatos; }
    public void setDetallesPlatos(List<PlatoInfo> detallesPlatos) { this.detallesPlatos = detallesPlatos; }
